/*
 *     jPSimp -  calculation and simplification of scalar fields.
...
public class Simplifier1D extends SimplifierND implements ScalarField1D {
    ...
    public void setCallback( Object obj, String func_name ) {
        try {
            this.cb = new Callback( obj, func_name, Simplifier1D.class );
